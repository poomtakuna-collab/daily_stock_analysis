  ...
  return (
    <AppPage className="space-y-5">
      <PageHeader
        ...
        title="Alert Center"
        description="Manage event alerts, daily technical indicators, watchlist, portfolio/account-linked rules, and market traffic-light rules. Run one-time tests and review trigger history from background evaluations."
      />
      ...
      <Card title="Notification attempts" subtitle="Notification results" variant="bordered" padding="md">
        ...
        {!notificationsLoading && notifications.length === 0 ? (
          <EmptyState
            ...
            description="There are no notification attempt details to show. Triggered alerts will still be sent through configured notification channels."
          />
        ) : null}
        {!notificationsLoading && notifications.length > 0 ? (
