...
const QUICK_QUESTIONS = [
  { label: 'Analyze AAPL with trend structure', skill: 'chan_theory' },
  { label: 'Review TSLA with wave theory', skill: 'wave_theory' },
  { label: 'Analyze NVDA trend', skill: 'bull_trend' },
  { label: 'Use range strategy on MSFT', skill: 'box_oscillation' },
  { label: 'Analyze Tencent HK00700', skill: 'bull_trend' },
  { label: 'Analyze market sentiment cycle', skill: 'emotion_cycle' },
];
    ...
    return (
      ...
      >
        ...
        <span className="flex items-center gap-1.5">
          <span className="opacity-60">Thinking process</span>
      ...
      <ScrollArea testId="chat-session-list-scroll" viewportClassName="p-3">
        {sessionsLoading ? (
          ...
          <DashboardStateBlock
            ...
            description="After you ask a question, sessions will appear here."
            className="rounded-2xl border border-dashed border-border/50 bg-surface/30"
          />
        ) : (
      ...
      <div className="flex h-full min-w-0 flex-1 flex-col overflow-hidden">
        <header className="mb-4 flex-shrink-0 space-y-3">
          <div className="flex items-start justify-between gap-4">
            ...
            {messages.length > 0 && (
              <div className="flex flex-shrink-0 flex-wrap items-center justify-end gap-2">
                <Tooltip content="Export session as Markdown">
                ...
                <Tooltip content="Send to configured notification bots/email">
                  <span className="inline-flex">
                    <Button
                      variant="action-primary"
                      size="sm"
                      ...
                      aria-label="Send to configured notification bots/email"
                    >
                      {sending ? (
                        <svg
          ...
          <p className="text-secondary-text text-sm">
            Ask AI about individual stocks and get skill-based trading advice with realtime decision reports.
          </p>
          {sendToast ? (
            <InlineAlert
          ...
          >
            {messages.length === 0 && !loading ? (
              <div className="flex h-full items-center justify-center">
                <EmptyState
                  title="Start asking"
                  description={'Enter a prompt such as "Analyze AAPL". AI will call realtime data tools to generate a decision report.'}
            ...
            <div className="space-y-3">
              ...
              {isFollowUpContextLoading ? (
                <InlineAlert
                  ...
                  message="Historical analysis context is loading. You can send a follow-up now."
              ...
              {skills.length > 0 && (
                <div className="space-y-2">
                  <button
                    ...
                    aria-label={mobileSkillPickerOpen ? 'Collapse strategy picker' : 'Expand strategy picker'}
            ...
            {activeStockCode && (
              ...
              <div className="flex items-end gap-3">
                <textarea
                  ...
                  placeholder="Example: Analyze AAPL / Is TSLA suitable to buy now? (Enter to send, Shift+Enter for newline)"
                  disabled={loading}
                  rows={1}
