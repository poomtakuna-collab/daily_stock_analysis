...
export const SettingsPanelErrorBoundary = (props: SettingsPanelErrorBoundaryProps) => {
  ...
  const labels: SettingsPanelErrorBoundaryLabels = language === 'en'
    ...
    : {
        ...
        runtimeErrorMessage: 'This settings section hit a frontend runtime error. Other settings on the page remain usable.',
        defaultDiagnosticHint: 'Provide the release version, runtime environment, and entry point to help diagnose the issue.',
        errorSummaryPrefix: 'Error summary: ',
      };
